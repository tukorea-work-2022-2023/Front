...
import 'package:book/screens/Major/MajorBoard/MajorDetail.dart';
...
class MajorAladin extends StatefulWidget {
  final String isbn;

  MajorAladin({required this.isbn});
  @override
  _MajorAladinState createState() => _MajorAladinState();
}

class _MajorAladinState extends State<MajorAladin> {
              ...
              GestureDetector(
                onTap: () {
                  if (bookInfo.isNotEmpty) {
                    ...
                    Get.to(() => MajorDetail(bookInfo: bookInfo));
                  }
                },
                child: Card(
                  child: Padding(
